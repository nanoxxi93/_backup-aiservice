...
namespace AIService.Services
{
    public class ObjectStorageService
    {
        ...
        public static async Task<Dictionary<string, object>> IamToken(AppSettings appSettings, RequestInDTO requestInDTO, string apiKey)
        {
            ...
            catch (Exception e)
            {
                Log.ForContext("Layer", $"{label}.{className}").ForContext("MethodName", methodName).ForContext("Ip", requestInDTO.Ip).ForContext("Guid", requestInDTO.Guid)
                    .Error(e, $"ERROR: {apiKey}");
                throw e;
            }
        }

        public static async Task<Dictionary<string, object>> Options(AppSettings appSettings, RequestInDTO requestInDTO, Dictionary<string, object> requestBody)
        {
            string methodName = "Options";
            Dictionary<string, object> result = new Dictionary<string, object>();
            try
            {
                Dictionary<string, object> iamToken = await IamToken(appSettings, requestInDTO, requestBody["apikey"].ToString());
        ...
        public static async Task<Dictionary<string, object>> Upload(AppSettings appSettings, RequestInDTO requestInDTO, IFormCollection requestBody)
        {
            ...
            try
            {
                ...
                response = await CommonService.HttpRequestContent(appSettings, url, requestBody["bucket"] + "/" + requestBody["objectkey"], "PUT", streamContent, headers, "Bearer", iamToken["access_token"].ToString());
        ...
        public static async Task<Dictionary<string, object>> UploadBytes(AppSettings appSettings, RequestInDTO requestInDTO, Dictionary<string, object> requestBody, byte[] file)
        {
            string methodName = "Upload";
            Dictionary<string, object> result = new Dictionary<string, object>();
            try
            {
                ...
                HttpResponseMessage response = new HttpResponseMessage();
                HttpContent streamContent;
                streamContent = new StreamContent(new MemoryStream(file));
                response = await CommonService.HttpRequestContent(appSettings, url, (string)requestBody["bucket"] + "/" + (string)requestBody["filename"], "PUT", streamContent, headers, "Bearer", iamToken["access_token"].ToString());
                result["result"] = await response.Content.ReadAsStringAsync();
                result["_statuscode"] = ((int)response.StatusCode).ToString() + response.StatusCode;
                return result;
            }
        ...
        public static async Task<Dictionary<string, object>> MultipartUpload(AppSettings appSettings, RequestInDTO requestInDTO, IFormCollection requestBody)
        {
        ...
        public static async Task<byte[]> Download(AppSettings appSettings, RequestInDTO requestInDTO, Dictionary<string, object> requestBody)
        {
        ...
        public static async Task<byte[]> DownloadHMAC(AppSettings appSettings, RequestInDTO requestInDTO, Dictionary<string, object> requestBody)
        {
