...
namespace aiservice.Services
{
    public class TwitterService
    {
        ...
        public static async Task<string> Bearer(AppSettings appSettings, RequestInDTO requestInDTO)
        {
        ...
        public static string OAuth(AppSettings appSettings, RequestInDTO requestInDTO, string url, string method, Dictionary<string, string> queryparams)
        {
        ...
        public static async Task<dynamic> TweetsSearchStandard(AppSettings appSettings, RequestInDTO requestInDTO, JObject requestBody)
        {
        ...
        public static async Task<dynamic> TweetsSearchPremium(AppSettings appSettings, RequestInDTO requestInDTO, JObject requestBody)
        {
