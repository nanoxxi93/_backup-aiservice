...
namespace aiservice.Services
{
    public class YoutubeService
    {
        ...
        public static async Task<dynamic> Search(AppSettings appSettings, RequestInDTO requestInDTO, JObject requestBody)
        {
        ...
        public static async Task<dynamic> CommentThreads(AppSettings appSettings, RequestInDTO requestInDTO, JObject requestBody)
        {
