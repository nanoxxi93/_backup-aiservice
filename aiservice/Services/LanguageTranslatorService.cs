...
namespace AIService.Services
{
    ...
    public class LanguageTranslatorService
    {
        ...
        public static dynamic LanguageTranslator(AppSettings appSettings, RequestInDTO requestInDTO, LanguageTranslatorRequest requestBody)
        {
        ...
        public static async Task<dynamic> GoogleLanguageTranslator(AppSettings appSettings, RequestInDTO requestInDTO, LanguageTranslatorRequest requestBody)
        {
