...
namespace AIService.Services
{
    ...
    public class NaturalLanguageUnderstandingService
    {
        ...
        public static dynamic NaturalLanguageUnderstanding(AppSettings appSettings, RequestInDTO requestInDTO, NaturalLanguageUnderstandingRequest requestBody, bool personalized = false)
        {
        ...
        public async static Task<Dictionary<string, object>> GoogleNaturalLanguageUnderstanding(AppSettings appSettings, RequestInDTO requestInDTO, string text)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    string translation = await LanguageTranslatorService.GoogleLanguageTranslator(appSettings, requestInDTO, languageTranslatorRequest);
