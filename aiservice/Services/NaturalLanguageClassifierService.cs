...
namespace AIService.Services
{
    ...
    public class NaturalLanguageClassifierService
    {
        ...
        public static dynamic NaturalLanguageClassifier(AppSettings appSettings, RequestInDTO requestInDTO, NaturalLanguageClassifierRequest requestBody)
        {
        ...
        public static dynamic NaturalLanguageClassifierTraining(AppSettings appSettings, RequestInDTO requestInDTO, IFormFile trainingDataFile, IFormCollection requestBody)
        {
            ...
            {
                Log.ForContext("Layer", $"{label}.{className}").ForContext("MethodName", methodName).ForContext("Ip", requestInDTO.Ip).ForContext("Guid", requestInDTO.Guid)
                    .Error(e, $"ERROR: {trainingDataFile.FileName}");
                throw e;
            }
        }

        public static dynamic NaturalLanguageClassifierList(AppSettings appSettings, RequestInDTO requestInDTO, NaturalLanguageClassifierRequest requestBody)
        {
        ...
        public static dynamic NaturalLanguageClassifierDetail(AppSettings appSettings, RequestInDTO requestInDTO, NaturalLanguageClassifierRequest requestBody)
        {
        ...
        public static dynamic NaturalLanguageClassifierDelete(AppSettings appSettings, RequestInDTO requestInDTO, NaturalLanguageClassifierRequest requestBody)
        {
            string methodName = "NaturalLanguageClassifierDetail";
            dynamic result = new ExpandoObject();
            try
